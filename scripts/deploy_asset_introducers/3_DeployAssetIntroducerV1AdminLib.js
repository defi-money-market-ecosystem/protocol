...
const main = async () => {
  ...
  const AssetIntroducerV1AdminLib = loader.truffle.fromArtifact('AssetIntroducerV1AdminLib');
  linkContract(AssetIntroducerV1AdminLib, 'ERC721TokenLib', erc721TokenLibAddress);
  await deployContract(
    AssetIntroducerV1AdminLib,
    [],
    deployer,
    1.5e6,
    web3,
