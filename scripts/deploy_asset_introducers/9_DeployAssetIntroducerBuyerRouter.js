...
const main = async () => {
  ...
  const AssetIntroducerV1BuyerRouter = loader.truffle.fromArtifact('AssetIntroducerV1BuyerRouter');
  await deployContract(
    AssetIntroducerV1BuyerRouter,
    [guardian, assetIntroducerProxyAddress, dmgTokenAddress, dmgIncentivePoolAddress],
    deployer,
    1.5e6,
    web3,
    defaultGasPrice,
